                                    ...
                                    <div>
                                        ...
                                        <div className="row mb-4">
                                            <div className="col-12">
                                                ...
                                                <p className="mb-0 text-break">{service.consent_text}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-md-6">
                                                ...
                                                <p className="mb-0">
                                                    <span className={`badge bg-${service.requires_parental_consent ? 'success' : 'secondary'}`}>
                                                        {service.requires_parental_consent ? 'Yes' : 'No'}
                                                    </span>
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row mb-4">
                                            ...
                                            <div className="col-md-6">
                                                ...
                                                <p className="mb-0">{service.expiry_date ? formatDate(service.expiry_date) : '-'}</p>
                                            </div>
                                        </div>

                                        {/* Age Requirement */}
                                        {service.min_age_requirement && (
                                            <div className="row mb-4">
                                                <div className="col-12">
                                                    <h6 className="text-muted text-uppercase fs-12 mb-2">
